...
def 转换格式(input_lora, output_lora, alpha, metadata={}):
    ...
    save_file(kohya_state_dict, output_lora, metadata={'source': str(input_lora), 'ss_base_model_version': 'sdxl_base_v1-0', 'ss_network_module': 'networks.lora'} | {k: str(v) for k, v in metadata.items()})
